...
# p = [value, value, value, value, value, value, value, value]
#p = fit
...
# Low precision
plot(x, (x - 14.186).* (x - 11.743).* (x - 14.273).* (x - 17.237).* (x - 14.268).* (x - 16.983) + 97.180)

# SIXTH ORDER 
#plot(x,  fit(1, 1).* (x - fit(2, 1)).* (x - fit(3, 1)).* (x - fit(4, 1)).* (x - fit(5, 1)).* (x - fit(6, 1)).* (x - fit(7, 1)) + fit(8, 1))
# Low precision
plot(x, 1.7839 * 10^(-02) .* (x - 5.7439 * 10^(+00)).* (x - 1.4059 * 10^(+01)).* (x - 1.1007 * 10^(+01)).* (x + 3.4243 * 10^(+01)).* (x - 1.5017 * 10^(+01)).* (x - 1.5007 * 10^(+01)) + 1.0516 * 10^(+02))
